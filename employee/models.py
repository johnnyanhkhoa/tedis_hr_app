...
class Leave_application(models.Model):    
    ...
    annual_note = models.CharField(max_length=200, blank=True, null=True)
    # Non-paid Leave
    ...
    non_paid_note = models.CharField(max_length=200, blank=True, null=True)
    # Wedding Leave
    ...
    wedding_note = models.CharField(max_length=200, blank=True, null=True)
    # Bereavement Leave
    ...
    bereavement_note = models.CharField(max_length=200, blank=True, null=True)
    ...
    maternity_obstetric_note = models.CharField(max_length=200, blank=True, null=True)
    # Sick Leave
    ...
    sick_note = models.CharField(max_length=200, blank=True, null=True)
    # Off in-lieu Leave
    ...
    offinlieu_note = models.CharField(max_length=200, blank=True, null=True)
    # Other Leave
